...
@NoArgsConstructor
public class FixedAsset extends AssetAudit {
    private String invoiceNumber;
    private String deprecationInfo;
    private Date purchaseDate;

    public FixedAsset(String assetNumber, String serialNumber, Vendor vendor, Location location, Model model, Type type, Status status, Manufacturer manufacturer, String invoiceNumber, String deprecationInfo, Date purchaseDate) {
