...
public class GenericDao {
    ...
    public <Dto extends BasicInfo,T, Service extends GenericBasicInfoService<Dto,T>> Dto checkAndCreate(AssetType assetType, Dto dto, Service service) throws Exception {
        if (dto.getId() == null) {
